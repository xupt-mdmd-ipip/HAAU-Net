...
show_image(load_image('./Dataset_BUSI_with_GT/benign/benign (100)_mask_1.png', SIZE))


# In[13]:


show_image(load_image('./Dataset_BUSI_with_GT/benign/benign (100)_mask.png', SIZE))
